---
title: "Центр офтальмологии «Ирис» (Краснодар) — отзывы о лазерной коррекции зрения"
date: 2026-05-15T10:00:00+03:00
draft: false
slug: "tsentr-oftalmologii-iris"
description: "Обзор клиники Центр офтальмологии «Ирис» в Краснодар. Отзывы пациентов о лазерной коррекции зрения, оборудование, методы коррекции."
city: "Краснодар"
tags:
  - obzor-klinik
  - kak-vybrat-kliniku
...
Клиника Центр офтальмологии "Ирис" (Краснодар) предлагает услуги по восстановлению остроты зрения современными хирургическими методами. В данном коротком информационном материале мы приводим данные об учреждении, взятые из открытых источников. Эта информация носит ознакомительный характер, может быть неполной или устаревшей, и не является официальным утверждением о наличии или отсутствии того или иного оборудования.

## Какое оборудование используется в Центр офтальмологии "Ирис"?
