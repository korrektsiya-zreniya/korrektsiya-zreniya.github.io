...
type: post
description: "Социальный проект, раскрывающий правду об осложнениях лазерной коррекции зрения. Независимая информация, помощь пострадавшим, реальные истории."
keywords:
  - социальный проект зрение
  - лазерная коррекция вся правда
  - поддержка пострадавших ласик
  - независимый сайт о зрении
