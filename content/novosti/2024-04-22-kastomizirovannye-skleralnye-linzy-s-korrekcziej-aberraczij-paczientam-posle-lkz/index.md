...
type: post
description: "Клиника доктора Майчук проводит исследование по подбору кастомизированных склеральных линз для пациентов с осложнениями после лазерной коррекции зрения (гало, двоение)."
keywords:
  - склеральные линзы исследование
  - доктор майчук линзы
  - коррекция аберраций после ласик
  - двоение после операции лечение
  - кастомизированные линзы цена
---
...
Если у вас есть проблемы с двоением, гало или бликами после ЛКЗ, эта возможность может быть вашим шансом на улучшение зрения. Чтобы узнать больше о том, как принять участие, куда прийти и во сколько, напишите доктору Наталии Майчук{{< img src="scale_1200-3.jpeg" alt="Доктор Наталия Майчук приглашает пациентов с осложнениями после ЛКЗ на тестирование кастомизированных склеральных линз" >}}

Источник: [https://pikabu.ru/story/issledovanie_dlya_resheniya_problem_posle_lazernoy_korrektsii_zreniya_novyie_skleralnyie_linzyi_11374345][1]
