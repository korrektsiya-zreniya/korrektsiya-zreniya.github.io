...
SMILE PRO — это разновидность лазерной коррекции зрения, выполняемая на лазере [ZEISS VisuMax 800](/zeiss-visumax/), при которой в роговице вырезается линза (лентикула), которую затем извлекают через крошечный разрез. Эта технология подается как менее инвазивная, быстрая, безопасная и современная альтернатива LASIK и FemtoLASIK.
