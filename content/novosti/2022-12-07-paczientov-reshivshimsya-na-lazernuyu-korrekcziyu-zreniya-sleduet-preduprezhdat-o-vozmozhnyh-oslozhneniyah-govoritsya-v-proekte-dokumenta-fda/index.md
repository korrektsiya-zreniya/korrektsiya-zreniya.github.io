...
type: post
description: "Проект документа FDA: пациентов необходимо предупреждать о риске двоения, сухости, боли и депрессии после лазерной коррекции зрения."
keywords:
  - fda lasik предупреждение
  - осложнения ласик документ
  - суицид после лазерной коррекции
  - хроническая боль после операции
  - рекомендации fda по зрению
---
